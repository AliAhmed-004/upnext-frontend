...
class SupabaseService {
  ...
  // Fetch all listings except current user's from Listings table
  Future<List<ListingModel>> fetchAllListings() async {
    ...
    // Fetch all listings except current user's in decending order of created_at
  ...
  Future<List<ListingModel>> fetchBookedListings() async {
    ...
    final rawBookedListings = await listingsTable
        .select('*')
        .eq('booked_by', userId).order('booked_at', ascending: false);
