...
/// Page for selecting a location on a map.
/// 
/// Used when creating a listing to pick the item's location.
/// Returns the selected [LatLng] when confirmed.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FlutterMap(
        ...
        options: MapOptions(
          initialCenter: const LatLng(33.6844, 73.0479), // Default: Islamabad
          initialZoom: 13,
      ...
      floatingActionButton: Column(
        ...
        children: [
          ...
          // Button to confirm selection (only shown when point is selected)
          if (_selectedPoint != null)
            FloatingActionButton(
